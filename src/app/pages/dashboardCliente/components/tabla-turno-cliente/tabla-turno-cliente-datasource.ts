...
export interface TablaTurnoClienteItem {
  estado: estadoTurno;
  numero: number;
  negocio: string;
  fecha: string;
 ...
 */
export class TablaTurnoClienteDataSource extends DataSource<TablaTurnoClienteItem> {


  data: TablaTurnoClienteItem[] = [];
   ...
   */
  connect(): Observable<TablaTurnoClienteItem[]> {
   ...
   */
  private getPagedData(data: TablaTurnoClienteItem[]): TablaTurnoClienteItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TablaTurnoClienteItem[]): TablaTurnoClienteItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'negocio':
          return compare(a.negocio.toLowerCase(), b.negocio.toLowerCase(), isAsc);
